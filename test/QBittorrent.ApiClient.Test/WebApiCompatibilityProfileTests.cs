...
{
    public sealed class WebApiCompatibilityProfileTests
    {
        [Fact]
        public void GIVEN_NullVersion_WHEN_ConstructingProfile_THEN_ShouldThrowArgumentNullException()
        {
            var action = () => new WebApiCompatibilityProfile((Version)null!);
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 11, 4));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 11, 5));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 11, 8));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 11, 9));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 11, 10));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 12, 0));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 12, 1));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 13, 0));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 13, 1));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 14, 1));
        ...
        {
            var target = new WebApiCompatibilityProfile(new Version(2, 15, 1));
        ...
        {
            var result = WebApiCompatibilityProfile.TryCreate("2.13.1", out var profile);
        ...
        {
            var result = WebApiCompatibilityProfile.TryCreate("invalid", out var profile);
        ...
        [Fact]
        public void GIVEN_WhitespaceVersionString_WHEN_TryCreateCompatibilityProfile_THEN_ShouldReturnFalse()
        {
            var result = WebApiCompatibilityProfile.TryCreate("   ", out var profile);
        ...
        {
            var result = WebApiCompatibilityProfile.TryCreate(null, out var profile);
