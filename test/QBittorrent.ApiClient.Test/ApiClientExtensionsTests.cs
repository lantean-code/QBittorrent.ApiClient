...
namespace QBittorrent.ApiClient.Test
{
    public sealed class ApiClientExtensionsTests
    {
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.StopTorrentsAsync(null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.StopTorrentAsync("Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.StopTorrentsAsync(null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.StopTorrentsAsync(null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.StopTorrentsAsync(new[] { "Hash1", "Hash2" }, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.StopTorrentsAsync(null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.StopTorrentsAsync(true, It.IsAny<CancellationToken>(), It.IsAny<string[]>()))
                .Returns(SuccessResult());

            await _target.StopAllTorrentsAsync(cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.StopTorrentsAsync(true, It.IsAny<CancellationToken>(), It.IsAny<string[]>()), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.StartTorrentsAsync(null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.StartTorrentAsync("Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.StartTorrentsAsync(null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.StartTorrentsAsync(null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.StartTorrentsAsync(new[] { "Hash1", "Hash2" }, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.StartTorrentsAsync(null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.StartTorrentsAsync(true, It.IsAny<CancellationToken>(), It.IsAny<string[]>()))
                .Returns(SuccessResult());

            await _target.StartAllTorrentsAsync(cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.StartTorrentsAsync(true, It.IsAny<CancellationToken>(), It.IsAny<string[]>()), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.DeleteTorrentsAsync(null, true, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.DeleteTorrentAsync("Hash", true, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.DeleteTorrentsAsync(null, true, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.DeleteTorrentsAsync(null, false, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.DeleteTorrentsAsync(new[] { "Hash1", "Hash2" }, false, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.DeleteTorrentsAsync(null, false, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.DeleteTorrentsAsync(true, true, It.IsAny<CancellationToken>(), It.IsAny<string[]>()))
                .Returns(SuccessResult());

            await _target.DeleteAllTorrentsAsync(true, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.DeleteTorrentsAsync(true, true, It.IsAny<CancellationToken>(), It.IsAny<string[]>()), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.GetTorrentListAsync(null, null, null, null, null, null, null, null, null, null, It.IsAny<CancellationToken>(), "Hash"))
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.SetTorrentCategoryAsync("Category", null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.SetTorrentCategoryAsync("Category", "Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.SetTorrentCategoryAsync("Category", null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.SetTorrentCategoryAsync("Category", null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.SetTorrentCategoryAsync("Category", new[] { "Hash1", "Hash2" }, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.SetTorrentCategoryAsync("Category", null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.SetTorrentCategoryAsync(string.Empty, null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.RemoveTorrentCategoryAsync("Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.SetTorrentCategoryAsync(string.Empty, null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.SetTorrentCategoryAsync(string.Empty, null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.RemoveTorrentCategoryAsync(new[] { "Hash1", "Hash2" }, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.SetTorrentCategoryAsync(string.Empty, null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.RemoveTorrentTagsAsync(new[] { "Tag1", "Tag2" }, "Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());
            ...
            Mock.Get(_target).Verify(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.RemoveTorrentTagAsync("Tag", "Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.RemoveTorrentTagAsync("Tag", new[] { "Hash1", "Hash2" }, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.RemoveTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.AddTorrentTagsAsync(new[] { "Tag1", "Tag2" }, "Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.AddTorrentTagsAsync(new[] { "Tag1", "Tag2" }, new[] { "Hash1", "Hash2" }, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag1", "Tag2" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.AddTorrentTagAsync("Tag", "Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))))
                .Returns(SuccessResult());

            await _target.AddTorrentTagAsync("Tag", new[] { "Hash1", "Hash2" }, cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.AddTorrentTagsAsync(It.Is<IEnumerable<string>>(tags => tags.SequenceEqual(new[] { "Tag" })), null, It.IsAny<CancellationToken>(), It.Is<string[]>(hashes => hashes.SequenceEqual(new[] { "Hash1", "Hash2" }))), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.RecheckTorrentsAsync(null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.RecheckTorrentAsync("Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.RecheckTorrentsAsync(null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        {
            Mock.Get(_target)
                .Setup(apiClient => apiClient.ReannounceTorrentsAsync(null, null, It.IsAny<CancellationToken>(), "Hash"))
                .Returns(SuccessResult());

            await _target.ReannounceTorrentAsync("Hash", cancellationToken: TestContext.Current.CancellationToken);

            Mock.Get(_target).Verify(apiClient => apiClient.ReannounceTorrentsAsync(null, null, It.IsAny<CancellationToken>(), "Hash"), Times.Once);
        }
        ...
        public async Task GIVEN_UsedAndUnusedCategories_WHEN_RemoveUnusedCategories_THEN_ShouldDeleteOnlyUnusedCategoryNames()
        {
            ...
            Mock.Get(_target)
                .Setup(apiClient => apiClient.GetTorrentListAsync(It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<bool?>(), It.IsAny<int?>(), It.IsAny<int?>(), It.IsAny<bool?>(), It.IsAny<bool?>(), It.IsAny<bool?>(), It.IsAny<CancellationToken>(), It.IsAny<string[]>()))
            ...
            Mock.Get(_target)
                .Setup(apiClient => apiClient.RemoveCategoriesAsync(It.IsAny<CancellationToken>(), It.IsAny<string[]>()))
                .Returns(SuccessResult());
            ...
            Mock.Get(_target).Verify(apiClient => apiClient.RemoveCategoriesAsync(It.IsAny<CancellationToken>(), It.Is<string[]>(categoryNames => categoryNames.SequenceEqual(new[] { "UnusedCategory" }))), Times.Once);
        }
        ...
        public async Task GIVEN_UsedAndUnusedTags_WHEN_RemoveUnusedTags_THEN_ShouldDeleteOnlyUnusedTags()
        {
            ...
            Mock.Get(_target)
                .Setup(apiClient => apiClient.DeleteTagsAsync(It.IsAny<CancellationToken>(), It.IsAny<string[]>()))
                .Returns(SuccessResult());
            ...
            Mock.Get(_target).Verify(apiClient => apiClient.DeleteTagsAsync(It.IsAny<CancellationToken>(), It.Is<string[]>(tagNames => tagNames.SequenceEqual(new[] { "UnusedTag" }))), Times.Once);
        }
