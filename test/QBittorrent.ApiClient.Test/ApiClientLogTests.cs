...
namespace QBittorrent.ApiClient.Test
{
    public class ApiClientLogTests
    {
        ...
        public async Task GIVEN_NoFilters_WHEN_GetLog_THEN_ShouldGETWithoutQueryAndReturnList()
        {
            ...
            var result = (await _target.GetLogAsync(cancellationToken: TestContext.Current.CancellationToken)).GetValueOrThrow();
        ...
        public async Task GIVEN_AllFilters_WHEN_GetLog_THEN_ShouldIncludeAllQueryParams()
        {
            ...
            var result = (await _target.GetLogAsync(normal: true, info: false, warning: true, critical: false, lastKnownId: 123, cancellationToken: TestContext.Current.CancellationToken)).GetValueOrThrow();
        ...
        [Fact]
        public async Task GIVEN_BadJson_WHEN_GetLog_THEN_ShouldReturnUnexpectedResponse()
        {
            ...
            var result = await _target.GetLogAsync(cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task GIVEN_NonSuccess_WHEN_GetLog_THEN_ShouldThrowWithStatusAndMessage()
        {
            ...
            result.ShouldFailWith(statusCode: HttpStatusCode.InternalServerError, userMessage: "boom");
        }
        ...
        public async Task GIVEN_NoLastKnownId_WHEN_GetPeerLog_THEN_ShouldGETWithoutQueryAndReturnList()
        {
            ...
            var result = (await _target.GetPeerLogAsync(cancellationToken: TestContext.Current.CancellationToken)).GetValueOrThrow();
        ...
        public async Task GIVEN_LastKnownId_WHEN_GetPeerLog_THEN_ShouldIncludeQueryParam()
        {
            ...
            var result = (await _target.GetPeerLogAsync(77, cancellationToken: TestContext.Current.CancellationToken)).GetValueOrThrow();
        ...
        public async Task GIVEN_NonSuccess_WHEN_GetPeerLog_THEN_ShouldThrowWithStatusAndMessage()
        {
            ...
            var result = await _target.GetPeerLogAsync(cancellationToken: TestContext.Current.CancellationToken);
